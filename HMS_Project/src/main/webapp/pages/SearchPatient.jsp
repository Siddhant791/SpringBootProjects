...
<!--             <div class="row">
                <div class="text-center col-xs-12 col-sm-12 col-md-12 col-lg-12 "> -->
                    <form action="/FindPatientByIdToSearch" method="get">
                        <div class="form ">
            ...
            <%
                ...
                <div class="form ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <input id="age" value="${patient.age}" min=0 max=999 name="age" required type="number" disabled>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <input value="${patient.dob}" required id="dob" name="dob" type="date" disabled>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <textarea id="address" name="address" required pattern="[a-zA-Z0-9\s]+" id="address"
                                style="resize: none;" rows="2" disabled>${patient.address}</textarea>
